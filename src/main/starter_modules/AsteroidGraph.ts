...
const getSdkMeteorDataset = async (): Promise<MeteorData[] | null> => {
  try {
...
class AsteroidGraph extends ModuleBase {
  ...
  async loadMeteors({ count = 5 }: LoadMeteorsOptions = {}): Promise<void> {
