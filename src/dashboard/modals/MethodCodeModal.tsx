...
export interface MethodCodeModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export const MethodCodeModal: React.FC<MethodCodeModalProps> = ({
  isOpen,
  onClose,
  moduleName,
  methodName,
}) => {
  const [methodCode, setMethodCode] = React.useState<string | null>(null);
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="large">
      <ModalHeader
        title={`METHOD: ${methodName?.toUpperCase() || ""}`}
        onClose={onClose}
      />
