...
const UserColors = ({
  ...
  const userColors: string[] = Array.isArray(config?.userColors)
    ? config.userColors
    : [];
  const [draft, setDraft] = React.useState(
    userColors[0] && isValidHexColor(userColors[0])
      ? userColors[0]
      : "#ffffff"
  );
            ...
            <>
              <div className="pl-12">
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setInputConfig({ ...inputConfig, type: e.target.value as "midi" | "osc" })
                  }
                  className="py-1 w-full"
                >
