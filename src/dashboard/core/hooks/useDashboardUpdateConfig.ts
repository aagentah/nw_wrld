...
type UseDashboardUpdateConfigArgs = {
  ...
  sequencerEngineRef: MutableRefObject<{
  ...
  return useCallback(
    (updates: Record<string, unknown>) => {
      ...
      if (
        ...
        sequencerEngineRef.current.setBpm?.(
          (updates as Record<string, unknown>).sequencerBpm as number
        );
      }
        ...
        if (hasUserColors) {
          ...
          for (const set of sets) {
            ...
            for (const track of tracks) {
              ...
              const modulesData =
                t && typeof t.modulesData === "object" && t.modulesData
              ...
              for (const instanceId of Object.keys(modulesData)) {
                ...
                const methodsByChannel =
                  md.methods && typeof md.methods === "object"
                    ? (md.methods as Record<string, unknown>)
                    : null;
