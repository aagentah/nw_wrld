...
const Modal = ({ isOpen, onClose, children, size = "small" }: ModalProps) => {
...
export type TemplateType = "basic" | "threejs" | "p5js";

export interface NewModuleDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onCreateModule: (moduleName: string, templateType: TemplateType) => void;
