...
import type { InputStatusData, InputConfig, UserConfig, Track } from "@/types";
...
export const DashboardFooter = ({
  ...
  const getStatusText = () => {
    ...
    if (inputStatus?.config) {
      const activeInput = inputStatus.config;
