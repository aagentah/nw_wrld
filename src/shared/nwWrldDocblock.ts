...
const normalizeDocblockValue = (value: unknown): string => {
...
const parseImportsList = (raw: string): string[] => {
...
const parseNwWrldDocblockMetadata = (
  text: unknown,
  maxBytes?: number
): ModuleMetadata => {
...
export { normalizeDocblockValue, parseNwWrldDocblockMetadata };

// Default export for compatibility with existing CommonJS imports
export default {
