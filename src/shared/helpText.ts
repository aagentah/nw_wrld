export const HELP_TEXT = {
  ...
  sequencerGrid:
    "16-step sequencer grid for creating patterns. Click cells to toggle steps (active=white, inactive=dark). Each row represents a step in time, columns represent channels.",
} as const;
